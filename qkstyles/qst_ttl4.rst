...
Groups 
    0, "Title"
Repcodes
1    ,  0, 0, 310,   100, "PCI Sans Serif Cond - Center (Subtitle)"
	Font        = "PCI Sans Serif Cond."
	Color       = FALSE; RGB ;0;0;0
	Size        = 5.100000	Alignment   = 1#0.000100
2    ,  0, 0, 310,   100, "PCI Sans Serif Cond - Center (Title)"
	Font        = "PCI Sans Serif Cond."
	Size        = 5.865000	Alignment   = 1#0.000100
3    ,  0, 0, 310,   100, "PCI Sans Serif Cond - Left (Subtitle)"
	Font        = "PCI Sans Serif Cond."
	Color       = FALSE; RGB ;0;0;0
	Size        = 5.100000	Alignment   = 0#0.000100
4    ,  0, 0, 310,   100, "PCI Sans Serif Cond - Left (Title)"
	Font        = "PCI Sans Serif Cond."
	Size        = 5.865000	Alignment   = 0#0.000100
5    ,  0, 0, 310,   100, "PCI Sans Serif Cond - Right (Subtitle)"
	Font        = "PCI Sans Serif Cond."
	Color       = FALSE; RGB ;0;0;0
	Size        = 5.100000	Alignment   = 2#0.000100
6    ,  0, 0, 310,   100, "PCI Sans Serif Cond - Right (Title)"
	Font        = "PCI Sans Serif Cond."
	Size        = 5.865000	Alignment   = 2#0.000100
EndTable
Color_Table ""
  0 FALSE; RGB ;0;0;0
...
EndTable
Lut_Table
Entry= 0 1 "CtrSub" PCI Sans Serif Cond - Center (Subtitle) 
Entry= 1 2 "CtrTtl" PCI Sans Serif Cond - Center (Title) 
Entry= 2 3 "LftSub" PCI Sans Serif Cond - Left (Subtitle) 
Entry= 3 4 "LftTtl" PCI Sans Serif Cond - Left (Title) 
Entry= 4 5 "RgtSub" PCI Sans Serif Cond - Right (Subtitle) 
Entry= 5 6 "RgtTtl" PCI Sans Serif Cond - Right (Title) 
Group= 0 0 Title
LutId= 0
LutId= 1
LutId= 2
